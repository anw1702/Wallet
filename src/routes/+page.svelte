<section class="bg-white dark:bg-gray-980">
  <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
    ...
    >
      <span
        class="text-xs bg-primary-600 rounded-full text-black px-4 py-1.5 mr-3"
        >Welcome to the</span
      > <span class="text-sm font-medium">TSoC Coding Phase</span>
      <svg
        class="ml-2 w-5 h-5"
        fill="currentColor"
        viewBox="0 0 20 20"
    ...
    >
      Learn Web3 fullstack development
    </h1>
    <p
    ...
    >
      ...
      <a
        href="https://https://www.youtube.com/watch?v=F9qIlkwrQdQ"
